...
Resend Code
</button> </div> </form> </div> <!-- Step 3: Success --> <div id="successStep" class="form-step" data-astro-cid-uv6iuh3x> <div class="success-content" data-astro-cid-uv6iuh3x> <div class="success-icon" data-astro-cid-uv6iuh3x>✓</div> <h3 data-astro-cid-uv6iuh3x>Login Successful!</h3> <p data-astro-cid-uv6iuh3x>Redirecting to your dashboard...</p> </div> </div> </div> <!-- Demo Notice --> <div class="demo-notice" data-astro-cid-uv6iuh3x> <p data-astro-cid-uv6iuh3x><strong data-astro-cid-uv6iuh3x>Demo Mode:</strong> For testing, the OTP will be shown on screen.</p> <p data-astro-cid-uv6iuh3x>In production, OTP will be sent to your email.</p> </div> </div> </div> ` })} ${renderScript($$result, "C:/Users/nirma/Desktop/New Website/src/pages/otp-login.astro?astro&type=script&index=0&lang.ts")} `;
