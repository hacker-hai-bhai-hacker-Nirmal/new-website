...
import { manifest } from './manifest_CEQpEYKZ.mjs';
...
const _page7 = () => import('./pages/login-test.astro.mjs');
const _page8 = () => import('./pages/menu.astro.mjs');
const _page9 = () => import('./pages/rewards.astro.mjs');
const _page10 = () => import('./pages/test-appwrite.astro.mjs');
const _page11 = () => import('./pages/test-simple.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/login-test.astro", _page7],
    ["src/pages/menu.astro", _page8],
    ["src/pages/rewards.astro", _page9],
    ["src/pages/test-appwrite.astro", _page10],
    ["src/pages/test-simple.astro", _page11],
